...
export {
    $, tween, isIOs, isMobile, isTouch, $wnd, $doc, $body, wndW, wndH, docH, debounceResize, throttleScroll, bodyOverflow, scrollbarWidth, isBodyOverflowed, isInViewport, scrollTo,
};
